var arrayOfLetters = ["tiger", "lion", "parrot", "peacock"];
var pickedLetter;
...
document.onkeyup = function (event) {
    ...
    if (lettersGuessed.indexOf(userGuess) != -1) {
        ...
        if (guessesLeft === 0) {
            ...
            if (prevWord === "peacock") {
                document.getElementById("imageid").src = "https://maxpull-gdvuch3veo.netdna-ssl.com/wp-content/uploads/2014/05/peacock-in-garden.jpg";
            }
            newGame();
        }
